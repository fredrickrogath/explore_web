  ...
  >
    <div>
      <div class="flex justify-center items-center">
        ...
        >
          <div class="my-4 text-lg">Sign in to Explore Larosa</div>
          <div class="flex justify-evenly relative h-[44px]">
            <div id="animate-icon-1" class="relative hidden p-2 pb-[52px] bg-white rounded-lg">
              <img
            ...
            <div id="animate-icon-2" class="relative hidden px-2 pt-1 pb-[55px] bg-white rounded-lg">
              <img
            ...
            <div id="animate-icon-3" class="relative hidden px-2 pt-1 pb-[55px] bg-white rounded-lg">
              <img
            ...
            <div id="animate-icon-4" class="relative hidden px-2 pt-1 pb-[55px] bg-white rounded-lg">
              <img
          ...
          <div class="my-4">Sign in with Email / Username</div>
          ...
          <div class="my-4 text-start">
            <div class="">
              ...
              >
                ...
                <div id="animate-form-4" class="mt-6 relative hidden text-center">
  ...
  methods: {
    ...
    //   this.validateEmail();
      ...
      if (!this.emailError && !this.passwordError) {
        ...
        // For demonstration purposes, we'll just set a timeout to simulate a server request
...
async function handleLogin() {
    try {
        const response = await fetch("http://192.168.1.46:8081/api/v1/auth/login", {
